		...
		<div class="container">
			<?php $APPLICATION->IncludeComponent(
				...
				[
					"CACHE_TIME"         => "3600",
					"CACHE_TYPE"         => "A",
					"HEADER_TEXT"              => "Мы растим в России новое поколение гениальных инженеров",
					"BLOCK_TITLE"              => "Наша миссия",
					"DESCRIPTION_TEXT"              => "Мы работаем для того, чтобы в России подрастало новое поколение талантливых и влюблённых в своё дело юных инженеров, робототехников и пилотов.",
